    ...
    void Update()
    {
        ...
        switch (stage)
        {
            case 0:
                if (timer <= 0)
                {
                    timer = timer + Random.Range(1.2f, 1.7f);
            ...
            case 1:
                if (timer <= 0)
                {
                    timer = timer + Random.Range(1.1f, 1.6f);
                    //StartCoroutine("SpawnEnemy");
                    Instantiate(enemy, spawner.transform.position, spawner.transform.rotation, canvas);
                }
                break;
            ...
            case 3:
                if (timer <= 0)
                {
                    timer = timer + Random.Range(.85f, 1.3f);
                    //StartCoroutine("SpawnEnemy");
                    Instantiate(enemy, spawner.transform.position, spawner.transform.rotation, canvas);
                }
                break;
            ...
            case 4:
                if (timer <= 0)
                {
                    timer = timer + Random.Range(.65f, 1.1f);
                    //StartCoroutine("SpawnEnemy");
                    Instantiate(enemy, spawner.transform.position, spawner.transform.rotation, canvas);
                }
                break;
            ...
            case 5:
                if (timer <= 0)
                {
                    timer = timer + Random.Range(.45f, .95f);
                    //StartCoroutine("SpawnEnemy");
                    Instantiate(enemy, spawner.transform.position, spawner.transform.rotation, canvas);
                }
                break;
